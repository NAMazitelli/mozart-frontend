        ...
        {isAnswered && validationResponse && (
          <IonCard className={`result-card ${isCorrect ? 'correct' : 'incorrect'}`}>
            <IonCardContent>
              ...
              <p><strong>Your guess:</strong> {formatFrequency(userFrequency)}</p>
              <p><strong>Correct answer:</strong> {exercise.eqDescription}</p>
              <p><strong>Difference:</strong> {validationResponse.difference} Hz</p>
